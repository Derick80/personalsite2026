...
/**
  ...
  /**
   * `prisma.arkhamChat`: Exposes CRUD operations for the **ArkhamChat** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ArkhamChats
    * const arkhamChats = await prisma.arkhamChat.findMany()
    * ```
    */
  get arkhamChat(): Prisma.ArkhamChatDelegate<ExtArgs, { omit: OmitOpts }>;
